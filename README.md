...
**Live app:** https://military-coding-club-hupmaos7oza8kba9vgtg8g.streamlit.app/
...
| **Natural Earth** | country boundaries | 1:110m | — |
...
```bash
git clone https://github.com/TheTrueKoschei/Military-Coding-Club.git
cd Military-Coding-Club
...
├── ne_110m_admin_0_countries.*   boundary shapefile (all five parts)
...
- **Boundaries** use Natural Earth's default de facto view.

---

## Credits

India Meteorological Department · NOAA Physical Sciences Laboratory · Natural Earth · Streamlit · Plotly · xarray · GeoPandas
